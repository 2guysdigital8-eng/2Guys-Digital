...
export default function CareersClient() {
    return (
        <div className="pt-[73px] bg-black">
            ...
            {/* Why Join Us */}
            <section className="py-24 px-6 md:px-12 bg-neutral-900 border-y border-white/5">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-16">
                        <h2 className="text-xs font-bold uppercase tracking-[0.4em] mb-4 text-[#bff549]">Perks & Benefits</h2>
                        <h3 className="text-4xl md:text-5xl font-black tracking-tighter uppercase text-white">Why Join <span className="italic text-[#bff549]">Us?</span></h3>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-px bg-white/5 border border-white/5">
                        {[
                            ...
                            <div key={benefit.title} className="bg-neutral-900 p-10 hover:bg-[#bff549]/5 transition-colors group">
                                <span className="material-symbols-outlined text-4xl mb-6 text-slate-500 group-hover:text-[#bff549] transition-colors">{benefit.icon}</span>
            ...
            {/* Open Positions */}
            <section className="py-32 px-6 md:px-12 border-b border-white/5 bg-black">
                <div className="max-w-5xl mx-auto">
                    <div className="text-center mb-16">
                        <h2 className="text-4xl md:text-6xl font-black tracking-tighter uppercase mb-4 text-white">Open <span className="italic text-[#bff549]">Roles</span></h2>
                    ...
                    <div className="space-y-4">
                        {jobs.length > 0 ? (
                            jobs.map((job) => (
                                <Link href={`/careers/${job.slug}`} key={job.title} className="group flex flex-col md:flex-row md:items-center justify-between p-8 border border-white/5 bg-neutral-900 hover:bg-neutral-800 transition-all">
                                    <div>
                                        <h4 className="text-2xl font-bold mb-2 text-white group-hover:text-[#bff549] transition-colors">{job.title}</h4>
                                    ...
                                    <div className="mt-6 md:mt-0 flex items-center justify-center size-12 border border-white/10 group-hover:border-[#bff549] bg-black group-hover:bg-[#bff549]/10 transition-colors">
                            ...
                            <div className="py-20 px-12 border border-dashed border-white/10 bg-neutral-900/50 text-center flex flex-col items-center">
                                <div className="size-20 bg-black rounded-full flex items-center justify-center mb-8 border border-white/5">
                                    <span className="material-symbols-outlined text-4xl text-slate-600">work_off</span>
                                </div>
                                <h4 className="text-2xl font-bold mb-4 uppercase tracking-tighter text-white">No open roles currently</h4>
                                <p className="text-slate-400 max-sm mx-auto mb-12">We are currently at capacity. Follow us or send a general application below to stay on our radar.</p>
