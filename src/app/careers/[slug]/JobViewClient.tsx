...
export default function JobViewClient({ job }: { job: any }) {
    ...
    return (
        <div className="pt-[73px] bg-black">
            {/* Job Header */}
            <section className="py-24 px-6 md:px-12 border-b border-white/5 bg-neutral-900">
                    ...
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
                        ...
                        {!showForm && (
                            <button
                                ...
                                className="bg-[#bff549] text-black h-16 px-12 flex items-center justify-center font-black uppercase tracking-widest text-xs -skew-x-12 hover:bg-white transition-all shadow-[0_0_30px_rgba(191,245,73,0.15)] group"
                            >
            ...
            <section className="py-24 px-6 md:px-12 max-w-5xl mx-auto">
                <div className={`grid ${showForm ? 'md:grid-cols-1' : 'md:grid-cols-3'} gap-20`}>
                    <div className={`${showForm ? 'hidden' : 'md:col-span-2'} prose prose-invert prose-slate max-w-none`}>
                    ...
                    <div className={showForm ? 'w-full' : 'md:col-span-1'}>
                        {showForm ? (
                            <div id="apply-form" className="scroll-mt-32">
                                ...
                                <JobApplyForm jobTitle={job.title} onClose={() => setShowForm(false)} />
                            </div>
                        ) : (
                                ...
                                <div className="space-y-6">
                                    {[
                                        ...
                                        <div key={step.s} className="flex gap-4">
                                            <span className="text-[10px] font-black text-slate-700">{step.s}</span>
                                            <div>
                                                <div className="text-sm font-bold uppercase tracking-widest mb-1">{step.t}</div>
            ...
            {/* Footer CTA */}
            <section className="border-t border-white/5 bg-black py-24 px-6 md:px-12">
                <div className="max-w-4xl mx-auto bg-neutral-900 border border-white/10 p-12 lg:p-20 text-center relative z-20 overflow-hidden">
